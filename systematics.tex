...
The variation of the cross section was observed to be around 1.0\% for \Dzero (two-body decay) and 2\% for the soft pion track. Therefore a value equal to 3\% was added to the per-track systematic uncertainty estimated for the ITS-TPC matching efficiency for the \Dstar -meson. The systematic uncertainties are shown in figure~\ref{fig:DzeroTrackSyst}. The systematic values are reported in Table~\ref{tab:DstarTrackingSyst}.
...
\begin{figure}[tb]
\begin{center}
 \includegraphics[width=0.65\textwidth]{figures/Dstar/pp13TeV/corrected-yield-ratio-tracking-Dstar-D0-single-track.pdf}
 \includegraphics[width=0.65\textwidth]{figures/Dstar/pp13TeV/tracking-soft-pion-ratio-cross-section.pdf}
...
\caption{Systematic uncertainty on tracking efficiency.}
